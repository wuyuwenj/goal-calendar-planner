import Svg, { Defs, LinearGradient, Stop, G, Line, Path, Ellipse } from 'react-native-svg';
...
export function TrellisIcon({ size = 24, color = COLORS.primary.forest, showBackground = false }: TrellisIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 1024 1024" fill="none">
      {showBackground && (
        <>
          ...
          <Path d="M0 0h1024v1024H0z" fill="url(#bgGradient)" />
        </>
      )}

      <G>
        {/* Trellis Structure - geometric diamond lattice pattern */}
        <G stroke={color} strokeWidth={28} fill="none" strokeLinecap="round" strokeLinejoin="round" opacity={0.95}>
